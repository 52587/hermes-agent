...
DEFAULT_CONFIG = {
    ...
    "kanban": {
        ...
        # In a multiplex Discord gateway, present public worker updates using
        # the executing profile's Bot. The origin still owns completion wakes.
        "discord_worker_updates": False,
